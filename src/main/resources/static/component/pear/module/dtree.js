...
//			level: "level",			  //层级
    ...
    DTree.prototype.setting = function(options) {
        ...
        if(this.obj && this.obj.length > 0 && !this.obj.attr("lay-filter") && this.obj[0].id) {
            this.obj.attr("lay-filter", this.obj[0].id);
        }
        ...
        if(_this.toolbar){
            if(_this.toolbarWay == "contextmenu") {
                ...
                if(_this.toolbarShow && _this.toolbarShow.length > 0) {
                    _this.obj.before("<div class='"+LI_DIV_TOOLBAR+" layui-nav' id='dtree_toolbar_"+_this.obj[0].id+"' lay-filter='dtree_toolbar_"+_this.obj[0].id+"'><div class='layui-nav-item'><dl class='layui-nav-child layui-anim'></dl></div></div>");
                }
            }
        }
